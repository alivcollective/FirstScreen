...
import { ClinicalWizard } from '@/components/symptoms/ClinicalWizard'

export const metadata: Metadata = {
  title: 'ตรวจอาการเบื้องต้น | FirstScreen',
  description: 'ระบบตรวจอาการ 7 ขั้นตอน พร้อมการวิเคราะห์อาการ — ไม่ใช่การวินิจฉัยโรค',
}
        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-800 py-10">
          <div className="mx-auto max-w-3xl px-4 sm:px-6">
            ...
            <p className="text-slate-400 text-sm max-w-xl">
              7 ขั้นตอน · วิเคราะห์อาการ · OLDCARTS · AUDIT-C
