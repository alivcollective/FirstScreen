...
// Hero — mobile-first, single primary CTA, ~20% shorter than v1
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-900">
      ...
      <div className="relative mx-auto max-w-3xl px-5 pt-14 pb-12 sm:pt-20 sm:pb-16 text-center">
        ...
        {/* Subtext — concise */}
        <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-7 max-w-xl mx-auto">
          ประเมินความเสี่ยงสุขภาพใน 3 นาที รับแผนตรวจคัดกรองเฉพาะบุคคล
          อิงหลักฐานจาก WHO และ สธ. ไทย
        </p>

        {/* Primary CTA — one button, high weight */}
        <div className="flex flex-col items-center gap-3 mb-7">
          ...
          {/* Secondary — ghost text link, lower visual weight */}
          <Link
            href="/symptoms"
            className="text-sm text-slate-400 hover:text-teal-300 transition-colors underline underline-offset-4 decoration-slate-700"
          >
            หรือตรวจอาการเบื้องต้น
          </Link>
        </div>

        {/* Trust sources */}
        <p className="text-slate-600 text-xs">
          อ้างอิงจาก <span className="text-slate-400 font-medium">WHO · สธ. ไทย · USPSTF · GRADE</span>
        </p>
      </div>
    </section>
  )
